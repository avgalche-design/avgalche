    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          {/* Header */}
          <div className="flex justify-between items-center p-4 sm:p-6 border-b border-gray-200">
            <h2 className="text-xl sm:text-2xl mx-auto font-bold">
              Shopping Cart
            </h2>
            <button
              onClick={() => setIsCartOpen(false)}
            ...
            {lines.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 sm:py-16 px-4 sm:px-6">
                <div className="w-24 h-24 sm:w-44 sm:h-44  rounded-full flex items-center justify-center mb-4">
                  <Image
                    src="/images/sadcart.png" // Path inside the public folder
                    alt="Profile picture"
                ...
                <button
                  onClick={() => setIsCartOpen(false)}
                  className="mt-6 bg-black text-white px-6 sm:px-8 py-3 rounded-lg font-semibold hover:bg-neutral-800 transition-colors text-sm sm:text-base"
                >
                  Continue Shopping
                </button>
              </div>
              ...
              <>
                ...
                <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-3 sm:space-y-4 max-h-[40vh] sm:max-h-[50vh]">
                  {lines.map(({ node }) => (
                    <div
                      key={node.id}
                ...
                {/* Footer with Subtotal and Checkout - Always visible */}
